...
use Tuke\Base\Users\Repositories\Contracts\UserRepositoryContract;
use Tuke\Base\Users\Repositories\UserRepository;

abstract class BaseAdminController extends BaseController
{
    /**
     * @var \Tuke\Base\Support\Breadcrumbs
     */
    public $breadcrumbs;

    /**
     * @var \Tuke\Base\Users\Models\User
     */
    protected $loggedInUser;

    /**
     * @var \Tuke\Base\AssetsManagement\Assets
     */
    public $assets;
    ...
    public function __construct()
    {
        ...
        $this->middleware(function (Request $request, $next) {
            $this->breadcrumbs = \Breadcrumbs::setBreadcrumbClass('breadcrumb')
                ->setContainerTag('ol')
                ->addLink('ADMIN', route('admin::dashboard.index.get'), '<i class="icon-home mr5"></i>');
