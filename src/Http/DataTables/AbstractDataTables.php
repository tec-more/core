<?php namespace Tuke\Base\Http\DataTables;
...
abstract class AbstractDataTables
{
    ...
    public $dataTableView = 'tuke-core::admin._components.datatables.table';
    ...
    protected function view()
    {
        ...
        add_action(BASE_ACTION_FOOTER_JS, function () use ($selector, $columns, $ajaxUrl) {
            echo view('tuke-core::admin._components.datatables.script-renderer', compact(
