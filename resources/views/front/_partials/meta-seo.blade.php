...
<!-- Google+ -->
<meta itemprop="name" content="{{ $pageTitle or '' }} - {{ get_setting('site_title', 'Tuke') ?: 'Tuke' }}">
...
<meta name="twitter:title" content="{{ $pageTitle or '' }} - {{ get_setting('site_title', 'Tuke') ?: 'Tuke' }}">
...
<!-- Open Graph data -->
<meta property="og:title" content="{{ $pageTitle or '' }} - {{ get_setting('site_title', 'Tuke') ?: 'Tuke' }}">
...
<meta property="og:site_name" content="{{ get_setting('site_title', 'Tuke') ?: 'Tuke' }}">
...
<meta property="article:section" content="{{ $pageTitle or '' }} - {{ get_setting('site_title', 'Tuke') ?: 'Tuke' }}">
