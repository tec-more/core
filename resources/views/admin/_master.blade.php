...
<head>
    ...
    <meta content="Admin dashboard - Tuke" name="description"/>
...
<div class="wrapper">
    {{--BEGIN Header--}}
    @include('tuke-core::admin._partials.header')
    {{--END Header--}}

    {{--BEGIN Sidebar--}}
    @include('tuke-core::admin._partials.sidebar')
    {{--END Sidebar--}}

    <div class="content-wrapper">
        <section class="content-header">
            {{--BEGIN Page title--}}
            @include('tuke-core::admin._partials.page-title')
            {{--END Page title--}}
            {{--BEGIN Breadcrumbs--}}
            @include('tuke-core::admin._partials.breadcrumbs')
            {{--END Breadcrumbs--}}
        </section>

        <section class="content">
            {{--BEGIN Flash messages--}}
            @include('tuke-core::admin._partials.flash-messages')
            {{--END Flash messages--}}
    ...
    {{--BEGIN Footer--}}
    @include('tuke-core::admin._partials.footer')
    {{--END Footer--}}

    {{--BEGIN control sidebar--}}
    @include('tuke-core::admin._partials.control-sidebar')
    {{--END control sidebar--}}
</div>

{{--Modals--}}
@include('tuke-core::admin._partials.modals')
...
<script src="{{ asset('admin/js/tuke-core.js') }}"></script>
