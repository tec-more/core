<header class="main-header">
    ...
    <a href="{{ asset('') }}" class="logo">
        ...
        <span class="logo-mini"><b>{{get_setting('mini_copyright_name')}}</b></span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b>{{get_setting('mini_copyright')}}</b></span>
    </a>
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    <a href="javascript:;"
                       ...
                       data-close-others="true">
                        <i class="fa fa-plus"></i>&nbsp;&nbsp;{{ trans('tuke-core::base.add_new') }}
                    </a>
                ...
                <li class="dropdown">
                    <a href="javascript:;"
                       ...
                       data-hover="dropdown"
                       data-close-others="true">
                        {{ trans('tuke-core::languages.' . dashboard_language()->getDashboardLanguage()) }}
                        <span class="fa fa-angle-down"></span>
                    </a>
                    <ul class="dropdown-menu">
                        @foreach(config('tuke.languages', []) as $slug => $language)
                            <li class="{{ $slug == dashboard_language()->getDashboardLanguage() ? 'active' : '' }}">
                                <a href="{{ route('admin::dashboard-language.get', [$slug]) }}">
                                    {{ trans('tuke-core::languages.' . $slug) }}
                                </a>
                            </li>
                        @endforeach
                    </ul>
                                ...
                                <div class="pull-left">
                                    <a href="{{ route('admin::users.edit.get', ['id' => $loggedInUser->id]) }}"
                                       class="btn btn-default btn-flat">
                                        <i class="icon-user"></i> {{ trans('tuke-users::base.profile') }}
                                    </a>
                                </div>
                                <div class="pull-right">
                                    <a href="{{ route('admin::auth.logout.get') }}" class="btn btn-default btn-flat">
                                        <i class="icon-logout"></i> {{ trans('tuke-users::auth.sign_out') }}
                                    </a>
                                </div>
                            </li>
                        @endif
