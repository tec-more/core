/*
 ...
 Source Database       : tuke_triangle_theme
...
-- ----------------------------
BEGIN;
INSERT INTO `permissions` VALUES ('1', 'Access to dashboard', 'access-dashboard', 'tuke-core'), ('2', 'System commands', 'use-system-commands', 'tuke-core'), ('3', 'View roles', 'view-roles', 'tuke-acl'), ('4', 'Create roles', 'create-roles', 'tuke-acl'), ('5', 'Edit roles', 'edit-roles', 'tuke-acl'), ('6', 'Delete roles', 'delete-roles', 'tuke-acl'), ('7', 'View permissions', 'view-permissions', 'tuke-acl'), ('8', 'Assign roles', 'assign-roles', 'tuke-acl'), ('9', 'View cache management page', 'view-cache', 'tuke-caching'), ('10', 'Modify cache', 'modify-cache', 'tuke-caching'), ('11', 'Clear cache', 'clear-cache', 'tuke-caching'), ('12', 'View custom fields', 'view-custom-fields', 'tuke-custom-fields'), ('13', 'Create field group', 'create-field-groups', 'tuke-custom-fields'), ('14', 'Edit field group', 'edit-field-groups', 'tuke-custom-fields'), ('15', 'Delete field group', 'delete-field-groups', 'tuke-custom-fields'), ('16', 'View files', 'elfinder-view-files', 'tuke-elfinder'), ('17', 'Upload files', 'elfinder-upload-files', 'tuke-elfinder'), ('18', 'Edit files', 'elfinder-edit-files', 'tuke-elfinder'), ('19', 'Delete files', 'elfinder-delete-files', 'tuke-elfinder'), ('20', 'View menus', 'view-menus', 'tuke-menus'), ('21', 'Delete menus', 'delete-menus', 'tuke-menus'), ('22', 'Create menus', 'create-menus', 'tuke-menus'), ('23', 'Edit menus', 'edit-menus', 'tuke-menus'), ('24', 'View plugins', 'view-plugins', 'tuke-modules-management'), ('25', 'View pages', 'view-pages', 'tuke-pages'), ('26', 'Create pages', 'create-pages', 'tuke-pages'), ('27', 'Edit pages', 'edit-pages', 'tuke-pages'), ('28', 'Delete pages', 'delete-pages', 'tuke-pages'), ('29', 'View settings page', 'view-settings', 'tuke-settings'), ('30', 'Edit settings', 'edit-settings', 'tuke-settings'), ('31', 'View themes', 'view-themes', 'tuke-themes-management'), ('32', 'View theme options', 'view-theme-options', 'tuke-themes-management'), ('33', 'Update theme options', 'update-theme-options', 'tuke-themes-management'), ('34', 'View users', 'view-users', 'tuke-users'), ('35', 'Create users', 'create-users', 'tuke-users'), ('36', 'Edit other users', 'edit-other-users', 'tuke-users'), ('37', 'Delete users', 'delete-users', 'tuke-users'), ('38', 'Force delete users', 'force-delete-users', 'tuke-users'), ('39', 'View contact forms', 'view-contact-forms', 'tuke-contact-form'), ('40', 'Update contact forms', 'update-contact-forms', 'tuke-contact-form'), ('41', 'Delete contact forms', 'delete-contact-forms', 'tuke-contact-form'), ('42', 'View posts', 'view-posts', 'tuke-blog'), ('43', 'Create posts', 'create-posts', 'tuke-blog'), ('44', 'Update posts', 'update-posts', 'tuke-blog'), ('45', 'Delete posts', 'delete-posts', 'tuke-blog'), ('46', 'View categories', 'view-categories', 'tuke-blog'), ('47', 'Create categories', 'create-categories', 'tuke-blog'), ('48', 'Update categories', 'update-categories', 'tuke-blog'), ('49', 'Delete categories', 'delete-categories', 'tuke-blog'), ('50', 'View tags', 'view-tags', 'tuke-blog'), ('51', 'Create tags', 'create-tags', 'tuke-blog'), ('52', 'Update tags', 'update-tags', 'tuke-blog'), ('53', 'Delete tags', 'delete-tags', 'tuke-blog');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `plugins` VALUES ('1', 'tuke-backup', null, '0', '0'), ('2', 'tuke-blog', '3.1.3', '1', '1'), ('3', 'tuke-captcha', '3.1.1', '1', '1'), ('4', 'tuke-contact-form', '3.1.4', '1', '1'), ('5', 'tuke-analytics', null, '0', '0'), ('6', 'tuke-ide', null, '0', '0'), ('7', 'tuke-blocks', null, '0', '0');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `view_trackers` VALUES ('1', 'Tuke\\Base\\Pages\\Models\\Page', '1', '368'), ('2', 'Tuke\\Base\\Pages\\Models\\Page', '3', '4'), ('3', 'Tuke\\Plugins\\Blog\\Models\\Category', '1', '80'), ('4', 'Tuke\\Plugins\\Blog\\Models\\Post', '1', '4'), ('5', 'Tuke\\Plugins\\Blog\\Models\\Post', '3', '34'), ('6', 'Tuke\\Plugins\\Blog\\Models\\Post', '2', '1'), ('7', 'Tuke\\Plugins\\Blog\\Models\\Post', '4', '3');
COMMIT;
