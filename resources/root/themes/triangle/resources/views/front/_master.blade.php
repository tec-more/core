...
<head>
    ...
    <title>{{ $pageTitle or '' }} - {{ get_setting('site_title', 'Tuke') ?: 'Tuke' }}</title>
...
<div class="wrapper" id="site_wrapper">
    ...
    <header class="header" id="header">
        @include('tuke-theme::front._partials.header')
    </header>

    @include('tuke-theme::front._partials.flash-messages')
    ...
    <footer class="footer" id="footer">
        @include('tuke-theme::front._partials.footer')
    </footer>
