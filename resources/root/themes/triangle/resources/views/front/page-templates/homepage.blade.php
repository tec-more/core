...
@section('content')
            ...
            <div class="row">
                <div class="main-slider">
                    <div class="slide-text">
                        <h1>{{ get_field($object->id, TUKE_PAGES, 'top_title') }}</h1>
                        <p>{{ get_field($object->id, TUKE_PAGES, 'top_description') }}</p>
                    </div>
    ...
    <section id="services">
        <div class="container">
            <div class="row">
                @foreach(get_field($object->id, TUKE_PAGES, 'services_section', []) as $key => $service)
                ...
                <div class="row">
                    <div class="action take-tour">
                        <div class="col-sm-7 wow fadeInLeft" data-wow-duration="500ms" data-wow-delay="300ms">
                            <h1 class="title">{{ get_field($object->id, TUKE_PAGES, 'tour_title') }}</h1>
                            <p>{{ get_field($object->id, TUKE_PAGES, 'tour_description') }}</p>
                        </div>
                        <div class="col-sm-5 text-center wow fadeInRight" data-wow-duration="500ms"
                             data-wow-delay="300ms">
                            <div class="tour-button">
                                <a href="{{ get_field($object->id, TUKE_PAGES, 'tour_link') }}" class="btn btn-common">TAKE THE TOUR</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section id="features">
        <div class="container">
            <div class="row">
                @foreach(get_field($object->id, TUKE_PAGES, 'features_section', []) as $key => $feature)
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="clients text-center wow fadeInUp" data-wow-duration="500ms" data-wow-delay="300ms">
                        ...
                        <h1 class="title">{{ get_field($object->id, TUKE_PAGES, 'clients_title') }}</h1>
                        <p>{{ get_field($object->id, TUKE_PAGES, 'clients_description') }}</p>
                    </div>
                    <div class="clients-logo wow fadeIn" data-wow-duration="1000ms" data-wow-delay="600ms">
                        @foreach(get_field($object->id, TUKE_PAGES, 'clients', []) as $client)
