                ...
                ajax: { // define ajax settings
                    ...
                    dataSrc: function (res) { // Manipulate the data returned from the server
                        if (res.customActionMessage) {
                            Tuke.showNotification(res.customActionMessage, res.customActionStatus);
                        }
                        ...
                        Tuke.unblockUI(_self.$tableContainer);

                        return res.data;
                    },
                    error: function () { // handle general connection errors
                        this.onError.call(undefined, _self);
                        Tuke.showNotification(this.dataTableParams.language.ajaxRequestGeneralError, 'danger');

                        Tuke.unblockUI($tableContainer);
                    }
                },
